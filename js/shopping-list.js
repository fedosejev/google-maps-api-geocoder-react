...
},{"./components/Application.jsx":169,"react":168,"react-dom":3}],2:[function(require,module,exports){
...
var Application = React.createClass({
  ...
  componentDidMount: function () {
    ...
    this.map = new google.maps.Map(mapElement, {
      zoom: 8,
      center: {
        lat: INITIAL_POSITION.latitude,
        lng: INITIAL_POSITION.longitude
      }
    });
    ...
    return React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement('input', { type: 'text', className: 'form-control input-lg', id: 'address', placeholder: 'London', ref: 'address' })
            ),
            React.createElement(
              'button',
      ...
      React.createElement(
        ...
        React.createElement(
          'div',
          { className: 'col-sm-12' },
          this.state.isGeocodingError ? React.createElement(
            'div',
            { className: 'bg-danger' },
            'Address not found.'
          ) : null,
